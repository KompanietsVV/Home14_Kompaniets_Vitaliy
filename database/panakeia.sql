...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Янв 28 2018 г., 10:37
...
--
-- База данных: `panakeia`
--

-- --------------------------------------------------------

--
-- Структура таблицы `ghwp_commentmeta`
--

CREATE TABLE `ghwp_commentmeta` (
...
--
-- Структура таблицы `ghwp_comments`
--

CREATE TABLE `ghwp_comments` (
...
--
-- Дамп данных таблицы `ghwp_comments`
--

INSERT INTO `ghwp_comments` (`comment_ID`, `comment_post_ID`, `comment_author`, `comment_author_email`, `comment_author_url`, `comment_author_IP`, `comment_date`, `comment_date_gmt`, `comment_content`, `comment_karma`, `comment_approved`, `comment_agent`, `comment_type`, `comment_parent`, `user_id`) VALUES
(1, 1, 'A WordPress Commenter', 'wapuu@wordpress.example', 'https://wordpress.org/', '', '2018-01-27 14:29:01', '2018-01-27 14:29:01', 'Hi, this is a comment.\nTo get started with moderating, editing, and deleting comments, please visit the Comments screen in the dashboard.\nCommenter avatars come from <a href=\"https://gravatar.com\">Gravatar</a>.', 0, 'post-trashed', '', '', 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `ghwp_links`
--

CREATE TABLE `ghwp_links` (
...
--
-- Структура таблицы `ghwp_options`
--

CREATE TABLE `ghwp_options` (
...
--
-- Дамп данных таблицы `ghwp_options`
--

INSERT INTO `ghwp_options` (`option_id`, `option_name`, `option_value`, `autoload`) VALUES
(1, 'siteurl', 'http://panakeia.my', 'yes'),
(2, 'home', 'http://panakeia.my', 'yes'),
(3, 'blogname', 'My Wordpress First Theme', 'yes'),
(4, 'blogdescription', 'Just another WordPress site', 'yes'),
(5, 'users_can_register', '0', 'yes'),
(6, 'admin_email', '23.013.acskiddedr@gmail.com', 'yes'),
...
(40, 'template', 'my_first_theme', 'yes'),
(41, 'stylesheet', 'my_first_theme', 'yes'),
...
--
-- Дамп данных таблицы `ghwp_postmeta`
--

INSERT INTO `ghwp_postmeta` (`meta_id`, `post_id`, `meta_key`, `meta_value`) VALUES
...
(8, 4, '_menu_item_xfn', ''),
(9, 4, '_menu_item_url', 'http://panakeia.my/'),
(10, 4, '_menu_item_orphaned', '1517084378'),
...
(17, 5, '_menu_item_xfn', ''),
(18, 5, '_menu_item_url', ''),
(19, 5, '_menu_item_orphaned', '1517084378'),
(25, 7, '_wp_trash_meta_status', 'publish'),
(26, 7, '_wp_trash_meta_time', '1517084581'),
...
(33, 8, '_menu_item_xfn', ''),
(34, 8, '_menu_item_url', 'http://panakeia.my/'),
(35, 8, '_menu_item_orphaned', '1517084606'),
(36, 9, '_menu_item_type', 'post_type'),
(37, 9, '_menu_item_menu_item_parent', '0'),
(38, 9, '_menu_item_object_id', '2'),
(39, 9, '_menu_item_object', 'page'),
(40, 9, '_menu_item_target', ''),
(41, 9, '_menu_item_classes', 'a:1:{i:0;s:0:\"\";}'),
(42, 9, '_menu_item_xfn', ''),
(43, 9, '_menu_item_url', ''),
(44, 9, '_menu_item_orphaned', '1517084606'),
(45, 10, '_edit_lock', '1517084910:1'),
(62, 10, '_wp_trash_meta_status', 'publish'),
(63, 10, '_wp_trash_meta_time', '1517084910'),
(64, 13, '_wp_trash_meta_status', 'publish'),
(65, 13, '_wp_trash_meta_time', '1517084979'),
(66, 2, '_edit_lock', '1517121175:1'),
(67, 14, '_wp_trash_meta_status', 'publish'),
(68, 14, '_wp_trash_meta_time', '1517119844'),
(69, 1, '_wp_trash_meta_status', 'publish'),
(70, 1, '_wp_trash_meta_time', '1517121269'),
(71, 1, '_wp_desired_post_slug', 'hello-world'),
(72, 1, '_wp_trash_meta_comments_status', 'a:1:{i:1;s:1:\"1\";}'),
(73, 2, '_wp_trash_meta_status', 'publish'),
(74, 2, '_wp_trash_meta_time', '1517121329'),
(75, 2, '_wp_desired_post_slug', 'sample-page'),
(76, 18, '_wp_trash_meta_status', 'publish'),
(77, 18, '_wp_trash_meta_time', '1517121467');

-- --------------------------------------------------------

--
-- Структура таблицы `ghwp_posts`
--

CREATE TABLE `ghwp_posts` (
...
--
-- Дамп данных таблицы `ghwp_posts`
--

INSERT INTO `ghwp_posts` (`ID`, `post_author`, `post_date`, `post_date_gmt`, `post_content`, `post_title`, `post_excerpt`, `post_status`, `comment_status`, `ping_status`, `post_password`, `post_name`, `to_ping`, `pinged`, `post_modified`, `post_modified_gmt`, `post_content_filtered`, `post_parent`, `guid`, `menu_order`, `post_type`, `post_mime_type`, `comment_count`) VALUES
(1, 1, '2018-01-27 14:29:01', '2018-01-27 14:29:01', 'Welcome to WordPress. This is your first post. Edit or delete it, then start writing!', 'Hello world!', '', 'trash', 'open', 'open', '', 'hello-world__trashed', '', '', '2018-01-28 06:34:29', '2018-01-28 06:34:29', '', 0, 'http://panakeia.my/?p=1', 0, 'post', '', 1),
(2, 1, '2018-01-27 14:29:01', '2018-01-27 14:29:01', 'This is an example page. It\'s different from a blog post because it will stay in one place and will show up in your site navigation (in most themes). Most people start with an About page that introduces them to potential site visitors. It might say something like this:\n\n<blockquote>Hi there! I\'m a bike messenger by day, aspiring actor by night, and this is my website. I live in Los Angeles, have a great dog named Jack, and I like pi&#241;a coladas. (And gettin\' caught in the rain.)</blockquote>\n\n...or something like this:\n\n<blockquote>The XYZ Doohickey Company was founded in 1971, and has been providing quality doohickeys to the public ever since. Located in Gotham City, XYZ employs over 2,000 people and does all kinds of awesome things for the Gotham community.</blockquote>\n\nAs a new WordPress user, you should go to <a href=\"http://panakeia.my/wp-admin/\">your dashboard</a> to delete this page and create new pages for your content. Have fun!', 'Sample Page', '', 'trash', 'closed', 'open', '', 'sample-page__trashed', '', '', '2018-01-28 06:35:29', '2018-01-28 06:35:29', '', 0, 'http://panakeia.my/?page_id=2', 0, 'page', '', 0),
(3, 1, '2018-01-27 14:29:41', '0000-00-00 00:00:00', '', 'Auto Draft', '', 'auto-draft', 'open', 'open', '', '', '', '', '2018-01-27 14:29:41', '0000-00-00 00:00:00', '', 0, 'http://panakeia.my/?p=3', 0, 'post', '', 0),
(4, 1, '2018-01-27 20:19:37', '0000-00-00 00:00:00', '', 'Home', '', 'draft', 'closed', 'closed', '', '', '', '', '2018-01-27 20:19:37', '0000-00-00 00:00:00', '', 0, 'http://panakeia.my/?p=4', 1, 'nav_menu_item', '', 0),
(5, 1, '2018-01-27 20:19:38', '0000-00-00 00:00:00', ' ', '', '', 'draft', 'closed', 'closed', '', '', '', '', '2018-01-27 20:19:38', '0000-00-00 00:00:00', '', 0, 'http://panakeia.my/?p=5', 1, 'nav_menu_item', '', 0),
(7, 1, '2018-01-27 20:23:01', '2018-01-27 20:23:01', '{\n    \"my_first_theme::header_image\": {\n        \"value\": \"http://panakeia.my/wp-content/uploads/2018/01/panakeia-logo.png\",\n        \"type\": \"theme_mod\",\n        \"user_id\": 1,\n        \"date_modified_gmt\": \"2018-01-27 20:23:01\"\n    },\n    \"my_first_theme::header_image_data\": {\n        \"value\": {\n            \"url\": \"http://panakeia.my/wp-content/uploads/2018/01/panakeia-logo.png\",\n            \"thumbnail_url\": \"http://panakeia.my/wp-content/uploads/2018/01/panakeia-logo.png\",\n            \"timestamp\": 1517084567302,\n            \"attachment_id\": 6,\n            \"width\": 157,\n            \"height\": 28\n        },\n        \"type\": \"theme_mod\",\n        \"user_id\": 1,\n        \"date_modified_gmt\": \"2018-01-27 20:23:01\"\n    }\n}', '', '', 'trash', 'closed', 'closed', '', '30bb7c6a-8507-41fe-8687-7cd46a08eebe', '', '', '2018-01-27 20:23:01', '2018-01-27 20:23:01', '', 0, 'http://panakeia.my/2018/01/27/30bb7c6a-8507-41fe-8687-7cd46a08eebe/', 0, 'customize_changeset', '', 0),
(8, 1, '2018-01-27 20:23:26', '0000-00-00 00:00:00', '', 'Home', '', 'draft', 'closed', 'closed', '', '', '', '', '2018-01-27 20:23:26', '0000-00-00 00:00:00', '', 0, 'http://panakeia.my/?p=8', 1, 'nav_menu_item', '', 0),
(9, 1, '2018-01-27 20:23:26', '0000-00-00 00:00:00', ' ', '', '', 'draft', 'closed', 'closed', '', '', '', '', '2018-01-27 20:23:26', '0000-00-00 00:00:00', '', 0, 'http://panakeia.my/?p=9', 1, 'nav_menu_item', '', 0),
(10, 1, '2018-01-27 20:28:30', '2018-01-27 20:28:30', '{\n    \"my_first_theme::header_image\": {\n        \"value\": \"random-uploaded-image\",\n        \"type\": \"theme_mod\",\n        \"user_id\": 1,\n        \"date_modified_gmt\": \"2018-01-27 20:25:59\"\n    },\n    \"my_first_theme::header_image_data\": {\n        \"value\": \"random-uploaded-image\",\n        \"type\": \"theme_mod\",\n        \"user_id\": 1,\n        \"date_modified_gmt\": \"2018-01-27 20:25:59\"\n    },\n    \"my_first_theme::nav_menu_locations[menu-1]\": {\n        \"value\": -591283571,\n        \"type\": \"theme_mod\",\n        \"user_id\": 1,\n        \"date_modified_gmt\": \"2018-01-27 20:26:59\"\n    },\n    \"nav_menu[-591283571]\": {\n        \"value\": {\n            \"name\": \"nav menu\",\n            \"description\": \"\",\n            \"parent\": 0,\n            \"auto_add\": false\n        },\n        \"type\": \"nav_menu\",\n        \"user_id\": 1,\n        \"date_modified_gmt\": \"2018-01-27 20:26:59\"\n    },\n    \"nav_menu_item[-691378064]\": {\n        \"value\": false,\n        \"type\": \"nav_menu_item\",\n        \"user_id\": 1,\n        \"date_modified_gmt\": \"2018-01-27 20:26:59\"\n    },\n    \"nav_menu_item[-1590099709]\": {\n        \"value\": {\n            \"object_id\": 0,\n            \"object\": \"custom\",\n            \"menu_item_parent\": 0,\n            \"position\": 1,\n            \"type\": \"custom\",\n            \"title\": \"Fusce at\",\n            \"url\": \"#\",\n            \"target\": \"\",\n            \"attr_title\": \"\",\n            \"description\": \"\",\n            \"classes\": \"\",\n            \"xfn\": \"\",\n            \"status\": \"publish\",\n            \"original_title\": \"Fusce at\",\n            \"nav_menu_term_id\": -591283571,\n            \"_invalid\": false,\n            \"type_label\": \"Custom Link\"\n        },\n        \"type\": \"nav_menu_item\",\n        \"user_id\": 1,\n        \"date_modified_gmt\": \"2018-01-27 20:27:59\"\n    },\n    \"nav_menu_item[-369783529]\": {\n        \"value\": {\n            \"object_id\": 0,\n            \"object\": \"custom\",\n            \"menu_item_parent\": 0,\n            \"position\": 2,\n            \"type\": \"custom\",\n            \"title\": \"Facilisis\",\n            \"url\": \"#\",\n            \"target\": \"\",\n            \"attr_title\": \"\",\n            \"description\": \"\",\n            \"classes\": \"\",\n            \"xfn\": \"\",\n            \"status\": \"publish\",\n            \"original_title\": \"Facilisis\",\n            \"nav_menu_term_id\": -591283571,\n            \"_invalid\": false,\n            \"type_label\": \"Custom Link\"\n        },\n        \"type\": \"nav_menu_item\",\n        \"user_id\": 1,\n        \"date_modified_gmt\": \"2018-01-27 20:28:30\"\n    }\n}', '', '', 'trash', 'closed', 'closed', '', 'e7fba085-2cfd-4abf-b8f2-9a63d2807956', '', '', '2018-01-27 20:28:30', '2018-01-27 20:28:30', '', 0, 'http://panakeia.my/?p=10', 0, 'customize_changeset', '', 0),
(13, 1, '2018-01-27 20:29:39', '2018-01-27 20:29:39', '{\n    \"my_first_theme::custom_logo\": {\n        \"value\": 6,\n        \"type\": \"theme_mod\",\n        \"user_id\": 1,\n        \"date_modified_gmt\": \"2018-01-27 20:29:39\"\n    },\n    \"my_first_theme::header_textcolor\": {\n        \"value\": \"blank\",\n        \"type\": \"theme_mod\",\n        \"user_id\": 1,\n        \"date_modified_gmt\": \"2018-01-27 20:29:39\"\n    }\n}', '', '', 'trash', 'closed', 'closed', '', '9da98ef4-b4d5-4db7-8683-5bc0624182b7', '', '', '2018-01-27 20:29:39', '2018-01-27 20:29:39', '', 0, 'http://panakeia.my/2018/01/27/9da98ef4-b4d5-4db7-8683-5bc0624182b7/', 0, 'customize_changeset', '', 0),
(14, 1, '2018-01-28 06:10:44', '2018-01-28 06:10:44', '{\n    \"my_first_theme::nav_menu_locations[menu-1]\": {\n        \"value\": 0,\n        \"type\": \"theme_mod\",\n        \"user_id\": 1,\n        \"date_modified_gmt\": \"2018-01-28 06:10:44\"\n    },\n    \"nav_menu[2]\": {\n        \"value\": false,\n        \"type\": \"nav_menu\",\n        \"user_id\": 1,\n        \"date_modified_gmt\": \"2018-01-28 06:10:44\"\n    }\n}', '', '', 'trash', 'closed', 'closed', '', '3f58835e-72e3-47a5-8382-f88c344886b7', '', '', '2018-01-28 06:10:44', '2018-01-28 06:10:44', '', 0, 'http://panakeia.my/2018/01/28/3f58835e-72e3-47a5-8382-f88c344886b7/', 0, 'customize_changeset', '', 0),
(15, 1, '2018-01-28 06:34:29', '2018-01-28 06:34:29', 'Welcome to WordPress. This is your first post. Edit or delete it, then start writing!', 'Hello world!', '', 'inherit', 'closed', 'closed', '', '1-revision-v1', '', '', '2018-01-28 06:34:29', '2018-01-28 06:34:29', '', 1, 'http://panakeia.my/2018/01/28/1-revision-v1/', 0, 'revision', '', 0),
(16, 1, '2018-01-28 06:35:29', '2018-01-28 06:35:29', 'This is an example page. It\'s different from a blog post because it will stay in one place and will show up in your site navigation (in most themes). Most people start with an About page that introduces them to potential site visitors. It might say something like this:\n\n<blockquote>Hi there! I\'m a bike messenger by day, aspiring actor by night, and this is my website. I live in Los Angeles, have a great dog named Jack, and I like pi&#241;a coladas. (And gettin\' caught in the rain.)</blockquote>\n\n...or something like this:\n\n<blockquote>The XYZ Doohickey Company was founded in 1971, and has been providing quality doohickeys to the public ever since. Located in Gotham City, XYZ employs over 2,000 people and does all kinds of awesome things for the Gotham community.</blockquote>\n\nAs a new WordPress user, you should go to <a href=\"http://panakeia.my/wp-admin/\">your dashboard</a> to delete this page and create new pages for your content. Have fun!', 'Sample Page', '', 'inherit', 'closed', 'closed', '', '2-revision-v1', '', '', '2018-01-28 06:35:29', '2018-01-28 06:35:29', '', 2, 'http://panakeia.my/2018/01/28/2-revision-v1/', 0, 'revision', '', 0),
(17, 1, '2018-01-28 06:36:30', '0000-00-00 00:00:00', '', 'Auto Draft', '', 'auto-draft', 'open', 'open', '', '', '', '', '2018-01-28 06:36:30', '0000-00-00 00:00:00', '', 0, 'http://panakeia.my/?p=17', 0, 'post', '', 0),
(18, 1, '2018-01-28 06:37:47', '2018-01-28 06:37:47', '{\n    \"sidebars_widgets[sidebar-1]\": {\n        \"value\": [],\n        \"type\": \"option\",\n        \"user_id\": 1,\n        \"date_modified_gmt\": \"2018-01-28 06:37:47\"\n    }\n}', '', '', 'trash', 'closed', 'closed', '', '93bb78cf-95da-40fc-9a6b-1313929bf20f', '', '', '2018-01-28 06:37:47', '2018-01-28 06:37:47', '', 0, 'http://panakeia.my/2018/01/28/93bb78cf-95da-40fc-9a6b-1313929bf20f/', 0, 'customize_changeset', '', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `ghwp_termmeta`
--

CREATE TABLE `ghwp_termmeta` (
  `meta_id` bigint(20) UNSIGNED NOT NULL,
...
--
-- Структура таблицы `ghwp_terms`
--

CREATE TABLE `ghwp_terms` (
...
--
-- Дамп данных таблицы `ghwp_terms`
--

INSERT INTO `ghwp_terms` (`term_id`, `name`, `slug`, `term_group`) VALUES
(1, 'Uncategorized', 'uncategorized', 0);

-- --------------------------------------------------------

--
-- Структура таблицы `ghwp_term_relationships`
--

CREATE TABLE `ghwp_term_relationships` (
...
--
-- Дамп данных таблицы `ghwp_term_relationships`
--

INSERT INTO `ghwp_term_relationships` (`object_id`, `term_taxonomy_id`, `term_order`) VALUES
(1, 1, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `ghwp_term_taxonomy`
--

CREATE TABLE `ghwp_term_taxonomy` (
...
--
-- Дамп данных таблицы `ghwp_term_taxonomy`
--

INSERT INTO `ghwp_term_taxonomy` (`term_taxonomy_id`, `term_id`, `taxonomy`, `description`, `parent`, `count`) VALUES
(1, 1, 'category', '', 0, 0);

-- --------------------------------------------------------

--
-- Структура таблицы `ghwp_usermeta`
--

CREATE TABLE `ghwp_usermeta` (
...
--
-- Дамп данных таблицы `ghwp_usermeta`
--

INSERT INTO `ghwp_usermeta` (`umeta_id`, `user_id`, `meta_key`, `meta_value`) VALUES
(1, 1, 'nickname', 'vitaliy'),
(2, 1, 'first_name', ''),
(3, 1, 'last_name', ''),
(4, 1, 'description', ''),
...
(11, 1, 'locale', ''),
(12, 1, 'ghwp_capabilities', 'a:1:{s:13:\"administrator\";b:1;}'),
(13, 1, 'ghwp_user_level', '10'),
(14, 1, 'dismissed_wp_pointers', ''),
(15, 1, 'show_welcome_panel', '1'),
(16, 1, 'session_tokens', 'a:1:{s:64:\"cb1711725aec3830da3f686009847ebaf1253d1dda45617ea9150d4dfa8cd148\";a:4:{s:10:\"expiration\";i:1518272977;s:2:\"ip\";s:9:\"127.0.0.1\";s:2:\"ua\";s:102:\"Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/59.0.3071.115 Safari/537.36\";s:5:\"login\";i:1517063377;}}'),
(17, 1, 'ghwp_dashboard_quick_press_last_post_id', '3'),
(18, 1, 'community-events-location', 'a:1:{s:2:\"ip\";s:9:\"127.0.0.0\";}'),
(19, 1, 'managenav-menuscolumnshidden', 'a:5:{i:0;s:11:\"link-target\";i:1;s:11:\"css-classes\";i:2;s:3:\"xfn\";i:3;s:11:\"description\";i:4;s:15:\"title-attribute\";}'),
(20, 1, 'metaboxhidden_nav-menus', 'a:1:{i:0;s:12:\"add-post_tag\";}'),
(21, 1, 'ghwp_user-settings', 'libraryContent=browse&mfold=o'),
(22, 1, 'ghwp_user-settings-time', '1517086601'),
(23, 1, 'nav_menu_recently_edited', '2');

-- --------------------------------------------------------

--
-- Структура таблицы `ghwp_users`
--

CREATE TABLE `ghwp_users` (
  `ID` bigint(20) UNSIGNED NOT NULL,
...
--
-- Дамп данных таблицы `ghwp_users`
--

INSERT INTO `ghwp_users` (`ID`, `user_login`, `user_pass`, `user_nicename`, `user_email`, `user_url`, `user_registered`, `user_activation_key`, `user_status`, `display_name`) VALUES
(1, 'vitaliy', '$P$B5mxrsG8ems2McC7pG2hwIdNja7HhS/', 'vitaliy', '23.013.acskiddedr@gmail.com', '', '2018-01-27 14:29:01', '', 0, 'vitaliy');
...
--
-- Индексы таблицы `ghwp_commentmeta`
--
ALTER TABLE `ghwp_commentmeta`
  ADD PRIMARY KEY (`meta_id`),
  ADD KEY `comment_id` (`comment_id`),
  ADD KEY `meta_key` (`meta_key`(191));

--
-- Индексы таблицы `ghwp_comments`
--
ALTER TABLE `ghwp_comments`
...
--
-- Индексы таблицы `ghwp_links`
--
ALTER TABLE `ghwp_links`
  ADD PRIMARY KEY (`link_id`),
  ADD KEY `link_visible` (`link_visible`);

--
-- Индексы таблицы `ghwp_options`
--
ALTER TABLE `ghwp_options`
  ADD PRIMARY KEY (`option_id`),
  ADD UNIQUE KEY `option_name` (`option_name`);

--
-- Индексы таблицы `ghwp_postmeta`
--
ALTER TABLE `ghwp_postmeta`
  ADD PRIMARY KEY (`meta_id`),
  ADD KEY `post_id` (`post_id`),
  ADD KEY `meta_key` (`meta_key`(191));

--
-- Индексы таблицы `ghwp_posts`
--
ALTER TABLE `ghwp_posts`
  ADD PRIMARY KEY (`ID`),
...
--
-- Индексы таблицы `ghwp_termmeta`
--
ALTER TABLE `ghwp_termmeta`
  ADD PRIMARY KEY (`meta_id`),
  ADD KEY `term_id` (`term_id`),
  ADD KEY `meta_key` (`meta_key`(191));

--
-- Индексы таблицы `ghwp_terms`
--
ALTER TABLE `ghwp_terms`
  ADD PRIMARY KEY (`term_id`),
  ADD KEY `slug` (`slug`(191)),
  ADD KEY `name` (`name`(191));

--
-- Индексы таблицы `ghwp_term_relationships`
--
ALTER TABLE `ghwp_term_relationships`
  ADD PRIMARY KEY (`object_id`,`term_taxonomy_id`),
  ADD KEY `term_taxonomy_id` (`term_taxonomy_id`);

--
-- Индексы таблицы `ghwp_term_taxonomy`
--
ALTER TABLE `ghwp_term_taxonomy`
  ADD PRIMARY KEY (`term_taxonomy_id`),
  ADD UNIQUE KEY `term_id_taxonomy` (`term_id`,`taxonomy`),
  ADD KEY `taxonomy` (`taxonomy`);

--
-- Индексы таблицы `ghwp_usermeta`
--
ALTER TABLE `ghwp_usermeta`
  ADD PRIMARY KEY (`umeta_id`),
  ADD KEY `user_id` (`user_id`),
  ADD KEY `meta_key` (`meta_key`(191));

--
-- Индексы таблицы `ghwp_users`
--
ALTER TABLE `ghwp_users`
  ADD PRIMARY KEY (`ID`),
...
--
-- AUTO_INCREMENT для таблицы `ghwp_commentmeta`
--
ALTER TABLE `ghwp_commentmeta`
  MODIFY `meta_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ghwp_comments`
--
ALTER TABLE `ghwp_comments`
  MODIFY `comment_ID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT для таблицы `ghwp_links`
--
ALTER TABLE `ghwp_links`
  MODIFY `link_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ghwp_options`
--
ALTER TABLE `ghwp_options`
  MODIFY `option_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=155;

--
-- AUTO_INCREMENT для таблицы `ghwp_postmeta`
--
ALTER TABLE `ghwp_postmeta`
  MODIFY `meta_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;

--
-- AUTO_INCREMENT для таблицы `ghwp_posts`
--
ALTER TABLE `ghwp_posts`
  MODIFY `ID` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT для таблицы `ghwp_termmeta`
--
ALTER TABLE `ghwp_termmeta`
  MODIFY `meta_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT для таблицы `ghwp_terms`
--
ALTER TABLE `ghwp_terms`
  MODIFY `term_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT для таблицы `ghwp_term_taxonomy`
--
ALTER TABLE `ghwp_term_taxonomy`
  MODIFY `term_taxonomy_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT для таблицы `ghwp_usermeta`
--
ALTER TABLE `ghwp_usermeta`
  MODIFY `umeta_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT для таблицы `ghwp_users`
--
ALTER TABLE `ghwp_users`
